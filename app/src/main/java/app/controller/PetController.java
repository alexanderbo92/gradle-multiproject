...
public class PetController {
  @Autowired private IRaceService rService;

  @Autowired private IDuenoService dService;

  @Autowired private IPetService pService;
  ...
  public String registrar(@ModelAttribute Pet objPet, BindingResult binRes, Model model)
    ...
    if (binRes.hasErrors()) {
      ...
      if (flag) return "redirect:/pet/listar";
      else {
  ...
  public String modificar(@PathVariable int id, Model model, RedirectAttributes objRedir)
    ...
    if (objPet == null) {
      ...
      if (objPet.isPresent()) objPet.ifPresent(o -> model.addAttribute("pet", o));
